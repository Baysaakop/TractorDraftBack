from .views import ManagerViewSet, MatchViewSet, GameweekViewSet, TableTeamViewSet, TableViewSet, LeagueViewSet, DuelViewSet, League19TeamViewSet, League19ViewSet
